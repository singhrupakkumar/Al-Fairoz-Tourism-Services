						...
						<div class="col-md-12 col-sm-12">
							...
							<div class="car-filter-holder">
								<div class="row">
										...
										<div class="car-filter">
											...
											<div class="select-list">
												<select id="from_location_id" name="from_location_id" class="selectpicker">
													...
													<?php $__currentLoopData = $finalresult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="col-md-3 col-sm-3">
										<button data-url="<?php echo e(route('get-filter-cabs')); ?>" id="search_cabs" class="search-btn">Search Cabs <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>	
									</div>
								...
								<div class="tab-pane" id="car-grid">
									...
									<div class="fleet-grid">
										<div class="row carFilterGetData">
											...
											<?php $__empty_1 = true; $__currentLoopData = $finalresult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
												...
												<div class="fleet-grid-box">
													...
													<figure class="fleet-thumb">
														...
														<figcaption class="fleet-caption">
															<div class="price-box">
																<strong>$<?php echo e($val->price); ?> <span>/ day</span></strong>
															</div>
														</figcaption>
													</figure>
													...
													<div class="fleet-info-box">
														<div class="fleet-info">
															...
															<span class="fas fa-star"></span>
															<ul class="fleet-meta">
																<li><i class="fas fa-taxi"></i><?php echo e($val->type); ?></li>
																<li><i class="fas fa-user-circle"></i><?php echo e(($val->adults_capacity) ? $val->adults_capacity : '0'); ?> Adult, <?php echo e(($val->children_capacity) ? $val->children_capacity : '0'); ?> Child</li>
															</ul>
														</div>
														<a href="<?php echo e(route('home.booknow'). '/'. \App\Helpers::encrypt($val->id)); ?>" class="tj-btn">Book Now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
													</div>
													<!--Fleet Grid Text End-->
												</div>
											</div>
			...
			<section class="tj-cal-to-action">
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-4">
							<div class="cta-box">
								<img src="<?php echo e(url('/')); ?>/prime-cab/images/cta-icon1.png" alt="">
								<div class="cta-text">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cta-box">
								<img src="<?php echo e(url('/')); ?>/prime-cab/images/cta-icon2.png" alt="">
								<div class="cta-text">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cta-box">
								<img src="<?php echo e(url('/')); ?>/prime-cab/images/cta-icon3.png" alt="">
								<div class="cta-text">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tour/resources/views/listing.blade.php ENDPATH**/ ?>