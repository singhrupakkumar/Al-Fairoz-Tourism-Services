							...
							<div class="col-md-4 col-sm-5 col-xs-12">
								<div class="field-outer">
									<select id="hotal_id" name="hotal_id" class="selectpicker">
										...
										<?php $__currentLoopData = $tour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="row hotalFilterGetData">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="tour-item-box">
											<a class="tour-item-box-img" href="<?php echo e(route('home.tour-detail') . '/multi-day-tour/'. \App\Helpers::encrypt($val->id)); ?>">
											...
											<div class="tour-item-box-text">
												...
												<a href="<?php echo e(route('home.tour-detail') . '/multi-day-tour/'. \App\Helpers::encrypt($val->id)); ?>"><?php echo e($val->hotal_name); ?></a>
												<div class="price-hr">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tour/resources/views/tour-listing.blade.php ENDPATH**/ ?>