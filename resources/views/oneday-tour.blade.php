								...
								<div class="row hotalFilterGetData">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="tour-item-box">
											<a class="tour-item-box-img" href="{{ route('home.tour-detail') . '/one-day-tour/'. \App\Helpers::encrypt($val->id) }}">
											...
											<div class="tour-item-box-text">
												...
												<a href="{{ route('home.tour-detail') . '/one-day-tour/'. \App\Helpers::encrypt($val->id) }}">{{ $val->hotal_name}}</a>
												<div class="price-hr">
