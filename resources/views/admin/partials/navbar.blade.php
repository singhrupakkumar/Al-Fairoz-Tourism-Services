...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{url('/')}}"><img src="{{ asset('storage/upload_image/'. \App\Helpers::setting()->logo ) }}" class="mr-2"
                alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{url('/')}}"><img src="{{ asset('storage/upload_image/'. \App\Helpers::setting()->logo ) }}" alt="logo" /></a>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <a class="nav-link dropdown-toggle" href="dropdown-logout" data-toggle="dropdown" id="profileDropdown">
                    ...
                    @endphp
                    <img src="{{ asset('/storage/upload_image/' . $profileImg)}}" alt="profile" />
                </a>
