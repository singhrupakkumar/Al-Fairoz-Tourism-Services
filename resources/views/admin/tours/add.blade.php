...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add Tours</h4>
                    <form action="{{ route('admin.tours.store') }}" class="form-sample" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tour_type') is-invalid @enderror" id="tour_type"
                                        ...
                                        <option value="day" {{ old('tour_type') == 'day' ? 'selected' : '' }}>Day
                                        </option>
                                        <option value="night" {{ old('tour_type') == 'night' ? 'selected' : '' }}>Night
                                        </option>
                                    </select>
                                    @error('tour_type')
                                        <span class="invalid-feedback" role="alert">
