        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.vehicles.update', $id) }}" class="form-sample" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    <label for="name">Vehicle Name<span>*</span></label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name',$vehiclesDetail->name) }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('type') is-invalid @enderror"
                                        id="type" name="type" step=".01" value="{{ old('type',$vehiclesDetail->type) }}">
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="make" class="form-control @error('make') is-invalid @enderror"
                                        id="price" name="make" step=".01" value="{{ old('make',$vehiclesDetail->make) }}">
                                    @error('make')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('model') is-invalid @enderror"
                                        id="model" name="model" value="{{ old('model',$vehiclesDetail->model) }}">
                                    @error('model')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('adults') is-invalid @enderror"
                                        id="adults" name="adults_capacity" value="{{ old('adults',$vehiclesDetail->adults_capacity) }}">
                                    @error('adults')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('children') is-invalid @enderror"
                                        id="children" name="children_capacity" value="{{ old('children',$vehiclesDetail->children_capacity) }}">
                                    @error('children')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                           ...
                           <!--  <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('from_location_id') is-invalid @enderror"
                                    ...
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}" {{($location->id == $vehiclesDetail->from_location_id) ? 'selected' : ''}}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('to_location_id') is-invalid @enderror"
                                    ...
                                    <option value="">Select Location</option>
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}" {{($location->id == $vehiclesDetail->to_location_id) ? 'selected' : ''}}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                                        id="price" name="price" value="{{ old('price',$vehiclesDetail->price) }}">
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('trip_date') is-invalid @enderror"
                                        id="trip_date" name="trip_date" value="{{ old('trip_date',$vehiclesDetail->trip_date) }}">
                                    @error('trip_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('trip_time') is-invalid @enderror"
                                        id="trip_time" name="trip_time" value="{{ old('trip_time',$vehiclesDetail->trip_time) }}">
                                    @error('trip_time')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 data-default-file="" /> -->
                                    ...
                                    @enderror
                                     <img src="{{ asset('storage/upload_image/'.$vehiclesDetail->image) }}" height="250" width="250" />
                                     <input type="hidden" name="oldVehicleImg" value="{{$vehiclesDetail->image}}">
                                </div>
                            </div>
                             <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('description') is-invalid @enderror"
                                        id="description" name="description" value="{{ old('description',$vehiclesDetail->description) }}">
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
