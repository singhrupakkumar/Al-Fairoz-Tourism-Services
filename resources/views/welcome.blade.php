							...
							@endif 
								...
								<div class="tab-content">
									<div class="tab-pane active" id="one-way">
										...
										<form  action="{{route('home.listing')}}" method="GET" class="trip-type-frm"> 
									...
									<div class="tab-pane" id="two-way">
										<!--Banner Form Content Start-->
										<form  action="{{route('home.tour-listing')}}" method="GET" class="trip-type-frm"> 
			...
			<section class="tj-offers">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<div class="offer-box">
							<img src="{{url('/')}}/prime-cab/images/offer-icon1.png" alt="">
					...
					<div class="col-md-3 col-sm-6">
						<div class="offer-box">
							<img src="{{url('/')}}/prime-cab/images/offer-icon2.png" alt="">
							<div class="offer-info">
					...
					<div class="col-md-3 col-sm-6">
						<div class="offer-box">
							<img src="{{url('/')}}/prime-cab/images/offer-icon3.png" alt="">
							<div class="offer-info">
								<h4>Home Pickups</h4>
								<p>A more recently with desktop softy  like aldus page maker.</p>
							</div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="offer-box">
							<img src="{{url('/')}}/prime-cab/images/offer-icon4.png" alt="">
							<div class="offer-info">
								<h4>Easy Bookings</h4>
								<p>A more recently with desktop softy  like aldus page maker.</p>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-7">
							<div class="about-info">
								...
								<a href="{{route('home.listing')}}">See all Vehicles<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
								<ul class="facts-list">
									<li>
						...
						<div class="col-md-6 col-sm-5">
							<div class="welcome-banner">
								<img src="{{url('/')}}/prime-cab/images/welcome-img.jpg" alt="">
							</div>
						</div>
						...
						<div class="owl-item">
							<div class="fleet-item">
								...
								<div class="fleet-inner">
									<h4>{{$val->name}}</h4>
									<ul>
										<li><i class="fas fa-taxi"></i>{{$val->model}}</li>
										<li><i class="fas fa-user-circle"></i>{{$val->adults_capacity}} Passengers</li>
									</ul>
									<strong class="price">${{$val->price}}<span> / day</span></strong>
									<a href="{{route('home.booknow'). '/'. \App\Helpers::encrypt($val->id) }}" target="_blank">Book Now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
								</div>
							</div>
						</div>
						@empty
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								...
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon1.png" alt="">
								</figure>
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								<!--Cab Services Thumb Start-->
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon2.png" alt="">
								</figure>
								<!--Cab Services Thumb End-->
								<!--Cab Services Info Start-->
								<div class="service-desc">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								<!--Cab Services Thumb Start-->
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon3.png" alt="">
								</figure>
								<!--Cab Services Thumb End-->
								<!--Cab Services Info Start-->
								<div class="service-desc">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								<!--Cab Services Thumb Start-->
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon4.png" alt="">
								</figure>
								<!--Cab Services Thumb End-->
								<!--Cab Services Info Start-->
								<div class="service-desc">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								<!--Cab Services Thumb Start-->
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon5.png" alt="">
								</figure>
								<!--Cab Services Thumb End-->
								<!--Cab Services Info Start-->
								<div class="service-desc">
						...
						<div class="col-md-4 col-sm-4">
							<div class="cab-service-box">
								<!--Cab Services Thumb Start-->
								<figure class="service-thumb">
									<img src="{{url('/')}}/prime-cab/images/cab-service-icon6.png" alt="">
								</figure>
								<!--Cab Services Thumb End-->
								<!--Cab Services Info Start-->
								<div class="service-desc">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-6">
							<div class="deal-box">
								...
								<div class="deal-info">
									<h4>{{$val->hotal_name}}</h4>
									<span>Starts from <strong>${{$val->price}}/day</strong></span>
								</div>
							</div>
						</div>
							...
							<div id="testimonial-slider" class="reviews-slider owl-carousel owl-theme">
								...
								<!--Review Item End-->
									...
									<div class="owl-item">
										<div class="review-item">
											<figure class="img-box">
												<img src="{{url('/')}}/prime-cab/images/testimonial-img2.png" alt="">
											</figure>
									...
									<div class="owl-item">
										<div class="review-item">
											<figure class="img-box">
												<img src="{{url('/')}}/prime-cab/images/testimonial-img1.png" alt="">
											</figure>
											<div class="review-info">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="news-box">
								<!--Newsbox Thumb Start-->
								<figure>
									<img src="{{url('/')}}/prime-cab/images/news_img1.jpg" alt="">
								</figure>
								<!--Newsbox Thumb End-->
						...
						<div class="col-md-4 col-sm-6">
							<div class="news-box">
								<!--Newsbox Thumb Start-->
								<figure>
									<img src="{{url('/')}}/prime-cab/images/news_img2.jpg" alt="">
								</figure>
								<!--Newsbox Thumb End-->
								<!--News Detail Content Start-->
								<div class="news-detail">
						...
						<div class="col-md-4 col-sm-12">
							<div class="news-list">
								...
								<ul class="news-outer">
									<li>
										<figure>
											<img src="{{url('/')}}/prime-cab/images/news_img3.jpg" alt="">
										</figure>
										<div class="news-info">
									...
									<li>
										<figure>
											<img src="{{url('/')}}/prime-cab/images/news_img4.jpg" alt="">
										</figure>
										<div class="news-info">
									...
									<li>
										<figure>
											<img src="{{url('/')}}/prime-cab/images/news_img5.jpg" alt="">
										</figure>
										<div class="news-info">
